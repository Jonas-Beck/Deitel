...
namespace FibonacciAsynchronous
{
    public partial class AsynchronousTestForm : Form
    {
        ...
        private async void startButton_Click(object sender, EventArgs e)
        {
            ...
            DateTime startTime = (results[0].StartTime < results[1].StartTime) ? results[0].StartTime : results[1].StartTime;
            DateTime endTime = (results[0].EndTime > results[1].EndTime) ? results[0].EndTime : results[1].EndTime;
